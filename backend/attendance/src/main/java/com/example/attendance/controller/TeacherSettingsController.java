...
import com.example.attendance.dto.TeacherSettingsDTO;
...
public class TeacherSettingsController {
    ...
    @GetMapping
    public ResponseEntity<TeacherSettingsDTO> getTeacherInfo(Principal principal) {
        if (principal == null) {
        ...
        TeacherSettingsDTO response = new TeacherSettingsDTO();
